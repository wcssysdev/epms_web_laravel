...
class DemoSeeder extends Seeder
{
    ...
    private function seedRoles(): void
    {
        $roles = [
            ...
            ['role_code' => 'admin',                 'role_name' => 'Estate Admin',            'level' => 35,  'required_system_type' => null],
            ...
            ['role_code' => 'pc',                    'role_name' => 'Plantation Controller',   'level' => 60,  'required_system_type' => null],
            ['role_code' => 'cs',                    'role_name' => 'Company Staff',           'level' => 60,  'required_system_type' => null],
    ...
    private function seedUsers(array $companies, string $password, $now): void
    {
        ...
        $userMatrix = [
            '1TEST' => [
                ...
                ['admin',              'estate_admin',   'Estate Admin'],
                ['pc',                 'pc',             'Plantation Controller'],
                ['cs',                 'cs',             'Company Staff'],
