...
@section('page-subtitle', 'Manage ' . strtolower($title) . ' records')
    ...
    <div class="rounded-xl border shadow-sm overflow-hidden"
        ...
        <div class="p-5">
            <div class="overflow-x-auto">
                <table id="txTable" class="w-full text-sm" style="color: var(--epms-text);">
                    <thead>
    ...
    <div x-show="showDelete" x-cloak class="fixed inset-0 z-50 flex items-center justify-center" x-transition>
        ...
        <div class="relative w-full max-w-sm rounded-xl border p-6 shadow-xl z-10"
            ...
            <p class="text-sm mb-5" style="color: var(--epms-text-muted);">
                Delete this {{ strtolower($title) }} record? This cannot be undone.
            </p>
...
function txTable() {
    return {
            ...
            dtCols.push({
                ...
                render: (d, t, r) => {
                    ...
                    <div class="flex gap-1">
                        ...
                        <button onclick="window.confirmTxDelete('${editBase}/${r.id}')"
        ...
        confirmDelete(url) { this.deleteUrl = url; this.showDelete = true; }
    }
}
</script>
@endpush
