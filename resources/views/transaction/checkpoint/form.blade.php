...
@section('content')
<div class="max-w-4xl" x-data="cpForm()">
    <form method="POST"
        ...
        <div class="rounded-xl border shadow-sm overflow-hidden mb-5"
            ...
            <div class="px-5 py-4 border-b" style="border-color: var(--epms-border);">
                <h2 class="text-sm font-semibold" style="color: var(--epms-text);">Checkpoint Details</h2>
            </div>
            <div class="p-5">
                        ...
                        <template x-for="(d, i) in details" :key="i">
                            <tr class="border-b" style="border-color: var(--epms-border);">
                                <td class="px-2 py-1.5">
                                    ...
                                    <input type="hidden" :name="`details[${i}][oph_platform_no]`" :value="d.oph_platform_no">
                                </td>
    ...
    return {
        ...
        addDetail(o) {
            this.details.push({
                ...
                oph_tph_code: o.tph_code, oph_platform_no: o.platform_no,
