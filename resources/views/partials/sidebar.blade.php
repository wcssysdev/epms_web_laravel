                    ...
                    <ul class="space-y-2">
                        <li>
                            ...
                            <ul x-show="open" x-collapse class="mt-1 space-y-1 pl-10">
                                ...
                                <li><a href="{{ route('transactions.overtime.index') }}" class="sidebar-subitem {{ str_starts_with($route,'transactions.overtime') ? 'font-semibold text-primary' : '' }}">Work Overtime</a></li>
                                <li><a href="{{ route('transactions.vra.index') }}" class="sidebar-subitem {{ str_starts_with($route,'transactions.vra') ? 'font-semibold text-primary' : '' }}">VRA (Equipment Activity)</a></li>
                                <li><a href="{{ route('transactions.platform_checking.index') }}" class="sidebar-subitem {{ str_starts_with($route,'transactions.platform_checking') ? 'font-semibold text-primary' : '' }}">Platform Checking</a></li>
                                @if($isPalm)
                                ...
                                <li><a href="{{ route('transactions.checkpoint_coconut.index') }}" class="sidebar-subitem {{ str_starts_with($route,'transactions.checkpoint_coconut') ? 'font-semibold text-primary' : '' }}">CP (Coconut)</a></li>
                                <li><a href="{{ route('transactions.grading_coconut.index') }}" class="sidebar-subitem {{ str_starts_with($route,'transactions.grading_coconut') ? 'font-semibold text-primary' : '' }}">Grading (Coconut)</a></li>
            ...
            <div class="mb-6">
                <nav>
                    <ul class="space-y-2">
                        ...
                        <li x-data="{ sapApprovalOpen: {{ str_starts_with($route,'sap-approval.') ? 'true':'false' }} }">
                            <button @click="sapApprovalOpen = !sapApprovalOpen" :aria-expanded="sapApprovalOpen.toString()"
                                    class="sidebar-item w-full text-left">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="size-6 shrink-0">
                                    <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
                                </svg>
                                <span>SAP Closing Approval</span>
                                <svg width="16" height="8" viewBox="0 0 16 8" fill="currentColor"
                                     class="ml-auto transition-transform duration-200"
                                     :class="sapApprovalOpen ? 'rotate-0' : 'rotate-180'">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.553.728a.687.687 0 01.895 0l6.416 5.5a.688.688 0 01-.895 1.044L8 2.155 2.03 7.272a.688.688 0 11-.894-1.044l6.417-5.5z"/>
                                </svg>
                            </button>
                            <ul x-show="sapApprovalOpen" x-collapse class="mt-1 space-y-1 pl-10">
                                <li><a href="{{ route('sap-approval.attendance.index') }}" class="sidebar-subitem {{ str_starts_with($route,'sap-approval.attendance') ? 'font-semibold text-primary' : '' }}">Attendance</a></li>
