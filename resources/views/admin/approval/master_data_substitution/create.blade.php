...
<div class="page-head">
    <div class="page-title">
        <h1>Add Master Data Substitution</h1>
    </div>
</div>
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-6">
                                <select name="target_employee_code" class="form-control select2" required {{ $systemLocked ? 'disabled' : '' }}>
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" {{ old('target_employee_code') == $user->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('substitution_from') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <span class="help-block">Start date of delegation</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('substitution_to') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <span class="help-block">End date of delegation</span>
                            </div>
                        </div>
                    </div>
